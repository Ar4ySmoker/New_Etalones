  ...
  $.fn.nineslider = function (options) {
    ...
    var methods = {
      ...
      initializeItems: function () {
        ...
        // $(settings.pagingTargetSelector)
        //   .find('[data-nineslider-paging-index="' + currentIndex + '"]')
        //   .addClass("active");
      ...
      appendHTML: function () {
        ...
        var navHTML =
          "<div class='nbs-nineslider-nav-left'></div><div class='nbs-nineslider-nav-right'></div>";
        ...
        childSet.each(function (index) {
          ...
          pagingHTML +=
            '<li data-nineslider-paging-index="' + index + '"></li>';
        });
        ...
        if (
          settings.pagingTargetSelector &&
          $(settings.pagingTargetSelector).length > 0
        ) {
      ...
      setEventHandlers: function () {
        $(settings.navigationTargetSelector)
          .find(".nbs-nineslider-nav-left")
          .on("click", function () {
            methods.navigate(true);
          });

        $(settings.navigationTargetSelector)
          .find(".nbs-nineslider-nav-right")
          .on("click", function () {
            methods.navigate(false);
          });

        $(settings.pagingTargetSelector)
          .find(".nbs-nineslider-paging")
          .on("click", "li", function (e) {
            var slideIndex = parseInt(
              $(e.currentTarget).attr("data-nineslider-paging-index")
            );
      ...
      navigate: function (reverse) {
        ...
        if (canNavigate == true) {
          ...
          var currentSlide = object.find(
            '[data-nineslider-index="' + currentIndex + '"]'
          );
      ...
      setPaging: function (index) {
        ...
        // $(settings.pagingTargetSelector)
        //   .find('[data-nineslider-paging-index="' + index + '"]')
        //   .addClass("active");
      },
